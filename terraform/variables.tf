...
variable "resource_group_name" {
  type        = string
  default     = "bacloud-other-rg"
  description = "Resource Group name"
}

####################################### LogAnalytics Variables ##############################

variable "log_analytics_workspace_name" {
  description = "Specifies the name of the log analytics workspace"
  default     = "bacloudAksWorkspace"
  type        = string
}
...
variable "hub_resource_group_name" {
  type        = string
  default     = "bacloud_hub_resource_group"
  description = "Resource Group name"
}
...
variable "aks_resource_group_name" {
  type        = string
  default     = "bacloud_aks_resource_group"
  description = "Resource Group name"
}

variable "aks_vnet_name" {
  description = "Specifies the name of the AKS subnet"
  default     = "bacloud_aks_vnet"
  type        = string
}
...
variable "admin_group_object_ids" {
  ...
  default     = ["43d22f3e-6cd5-4afd-b94a-487761a4f74a"]
  type        = list(string)
}
